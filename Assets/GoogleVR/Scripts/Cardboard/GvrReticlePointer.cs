...
public class GvrReticlePointer : GvrBasePointer {
  ...
  public override float MaxPointerDistance { get { return maxReticleDistance; } }
    ...
    public void OnPointerEnter(RaycastResult raycastResultResult)
  {
        if(raycastResultResult.gameObject.tag == "Interact")
        {
            SetPointerTarget(raycastResultResult.worldPosition, true);
        }
